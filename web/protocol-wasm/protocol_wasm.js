...
export class ProtocolSession {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ProtocolSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_protocolsession_free(ptr, 0);
    }
    /**
    ...
    ack_msg() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.protocolsession_ack_msg(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     * @returns {string}
     */
    commit_move(sfen, usi) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passStringToWasm0(sfen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(usi, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.protocolsession_commit_move(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    feed(msg) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.protocolsession_feed(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    hello_msg() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.protocolsession_hello_msg(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    constructor(side, secret) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.protocolsession_new(ptr0, len0, ptr1, len1);
        this.__wbg_ptr = ret;
        ProtocolSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    reveal_msg() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.protocolsession_reveal_msg(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./protocol_wasm_bg.js": import0,
    };
}

const ProtocolSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_protocolsession_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('protocol_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
