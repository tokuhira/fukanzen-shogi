...
- [ルール版の系譜と対局モード 方針](design/不完全将棋_ルール版の系譜と対局モード_方針.md) — レガシールール対局（engine 版ディスパッチ・版選択交渉で旧版を葬らず選んで指せる）と時間制（protocol 層の終局・対局モード）の二直交軸。実装は最初のルール変更・時間制の必要に付随して発火、今は背骨のみ。
