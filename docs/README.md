...
- [記録係三段目（封蝋）— 概観と段組](archive/implementation/recorder-seal/不完全将棋_記録係三段目_封蝋アーク_概観と段組.md) — 二証人の上に**記録係署名＝完全性の封蝋**を重ねる（記録係二段目 §13 の申し送り）。封じるのは中身の完全性だけ（帰属・consent・裁定には及ばない）。Ed25519・行ベース正準化・鍵が無ければ封蝋を省いて従来どおり綴じる。段組は Seal-1〜4。**Seal-1・Seal-2 実装済み・Seal-3 指示書まで着地（未デプロイ）。**
